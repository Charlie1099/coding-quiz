...
pageContentEl.quirySelector("#start");
    console.log("#start")

var pageContentEl = "#start"
...
/* I relize that this in not done. I just wnated to turn in at lest somthing in on time becuse the last projest
